...
R1INTERNATIONAL =  { "20g": ["5,5","5,80"], "100g": ["6,75","7,10"], "250g": ["10,45","11,00"],"500g": ["14,15","14,90"],"2kg": ["21,55","22,70"] }
R2INTERNATIONAL =  { "20g": ["6,46","6,80"], "100g": ["7,69","8,10"], "250g": ["11,4","12"], "500g": ["15,1","15,9"],"2kg": ["22,5","23,70"] }
AR = {"1,15"}
ARINTERNATIONAL = {"1,40"}
VERT = [PACKVERT]
PRIO = [PACKPRIO,PRIOINTERNATIONAL]
SUIVIE = [PACKSUIVIE,SUIVIEINTERNATIONAL]
RECO = [ RECOMMANDER1, RECOMMANDER2, RECOMMANDER3, R1INTERNATIONAL, R2INTERNATIONAL, AR, ARINTERNATIONAL ]
